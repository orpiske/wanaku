...
public final class ResourceHelper {
    ...
    public static void exposeAsync(
            ...
            ResourceManager resourceManager,
            BiFunction<ResourceManager.ResourceArguments, ResourceReference, List<ResourceContents>> handler) {
        exposeAsync(executor, resourceReference, resourceManager, null, handler);
    }
    ...
    public static void exposeAsync(
        ...
        try {
            final ResourceManager.ResourceDefinition resourceDefinition = resourceManager
                    ...
                    .setMimeType(resourceReference.getMimeType())
                    .setDescription(resourceReference.getDescription())
                    .setAsyncHandler(args -> runAsync(executor, resourceReference, args, handler));
    ...
    private static Uni<ResourceResponse> runAsync(
            Executor executor,
            ResourceReference resourceReference,
            ResourceManager.ResourceArguments arguments,
            BiFunction<ResourceManager.ResourceArguments, ResourceReference, List<ResourceContents>> handler) {
        return Uni.createFrom()
                .item(() -> handler.apply(arguments, resourceReference))
                ...
                .onItem()
                .ifNotNull()
                .transform(v -> new ResourceResponse(v));
    }
}
