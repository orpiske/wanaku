    ...
    private void doExposeResourceAsync(ResourceReference resourceReference) {
        if (!StringHelper.isEmpty(resourceReference.getNamespace())) {
            ...
            ResourceHelper.exposeAsync(
                    resourceReference, resourceManager, namespace, resourceBridge::readAsyncV2);
        } else {
            ResourceHelper.exposeAsync(resourceReference, resourceManager, resourceBridge::readAsyncV2);
        }
    }
